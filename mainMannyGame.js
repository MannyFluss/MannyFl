...
class enemySpawner
{
  ...
  spawnEnemy()
  {
    let angle = Math.random()*Math.PI*2 * rad2Pi;
...
{
  //fix the input,pos.x and y to be accurate
    mousePosition = vec(mouseX,mouseY)
...
setInterval(function() {
  var rect = document.getElementById("mannyGameCanvas").getBoundingClientRect();

}, 100); // Update every 100 milliseconds


addEventListener("mousedown", onLoad);
